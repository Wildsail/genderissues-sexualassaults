...
function nextItem() {
  ...
  var $currentdot = $('.dot-nav--item').eq(currentSlideNumber);
  $currentdot.addClass('is-active');
  $currentdot.siblings().removeClass('is-active');
  var $currentblink = $('.b-link').eq(currentSlideNumber);
  $currentblink.addClass('active');
  $currentblink.siblings().removeClass('active');
}
